function [modelFile, trainLoss] = train_pirn_model_6(sampleFile, trainParams)
% PINN
...
% https://benmoseley.blog/my-research/so-what-is-a-physics-informed-neural-network/
    ...
    for i = 1:numMiddle
        layers = [
            ...
            tanhLayer("Name",['tanh', num2str(2*i)])
            fullyConnectedLayer(trainParams.numNeurons, "Name",['fc',num2str(2*i+1)])
            tanhLayer("Name",['tanh', num2str(2*i+1)])
    ...
    lgraph = connectLayers(lgraph, "tanh1", "add1/in2");
    for i = 1:numMiddle-1
